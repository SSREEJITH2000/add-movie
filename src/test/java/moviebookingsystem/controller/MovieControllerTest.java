...
public class MovieControllerTest {
    ...
    void testUpdateMovieById() throws Exception{
        ...
        when(movieService.updateMovieById(eq(movieId),any(MovieRequest.class))).thenReturn(updatedMovie.getId());
    ...
    void testAddShowTimesToMovie() throws Exception{
        ...
        mockMvc.perform(post("/movies/{id}/showTimes", movieId)
    ...
    void testDeleteShowTime() throws Exception{
        ...
        mockMvc.perform(delete("/movies/{id}/showTimes/{showTimeId}",id,showTimeId)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    ...
    void testCreateBooking() throws Exception{
        String jsonRequest = "{ \"movieId\": 1, \"showTimeId\": 1, \"userId\": 1, \"seats\": [\"A1\", \"A2\"] }";

        mockMvc.perform(post("/movies/1/showTimes/1/bookings")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonRequest))
                .andExpect(status().isOk());
